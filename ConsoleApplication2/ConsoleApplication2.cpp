...
void zad4() {
    ...
    // Меняю местами без временной переменной
...
// Функции для заданий 10-11 были бы здесь, но их нужно реализовать отдельно
// Для заданий 10-11 нужно добавить функции транспонирования, проверки симметричности и вычисления нормы матрицы
